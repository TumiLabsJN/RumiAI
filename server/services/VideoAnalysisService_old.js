...
class VideoAnalysisService {
    ...
    async runVideoIntelligenceAnalysis(gcsVideos) {
        ...
        for (let i = 0; i < gcsVideos.length; i++) {
            ...
            try {
                ...
                // Merge Whisper transcription into analysis
                if (video.whisperTranscription) {
                    analysis.speechTranscriptions = video.whisperTranscription.speechTranscriptions || [];
                    analysis.transcript = video.whisperTranscription.transcript || '';
                    analysis.wordCount = video.whisperTranscription.wordCount || 0;
                    analysis.speechSegments = video.whisperTranscription.segments || [];
                }
    ...
    processVideoIntelligenceResult(result) {
        ...
        // Speech transcription will be handled by Whisper after download
        processed.speechTranscriptions = [];
        console.log('🎤 Speech transcription will be processed locally with Whisper');
